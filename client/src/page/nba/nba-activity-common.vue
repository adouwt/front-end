<template>
  <div class="nba-bg">
    <div>
      <img src="../../assets/img/games/nba/nba-tel.png" alt="" class="nba-user-tel">
      <span class="nba-activity-username">
        185****7735
      </span>
    </div>
